    ...
    <div class="col-md-9">
        ...
        <div class="card p-4 shadow-sm border-0 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="/job_add.php" class="btn btn-primary rounded-pill btn-sm px-4 shadow-sm"><i class="bi bi-plus-lg me-2"></i>Přidat pozici</a>
            </div>
                            ...
                            <?php foreach ($jobs as $job): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span class="badge bg-success rounded-pill"><?= $matches ?> top matches</span>
                                    </td>
                                    <td class="text-end">
